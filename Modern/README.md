...
- Avalonia desktop browser for folders, ZIP, XP3, TCD, Morning PAK, Moonhir FPK, and CMP archives.
...
- CLI listing and safe extraction for ZIP, XP3, TCD, Morning PAK, Moonhir FPK, and CMP archives.
