...
- Avalonia desktop browser for folders, ZIP, XP3, TCD, Morning PAK, Moonhir FPK, CMP, PKG/2, CSAF, MBL, NPK, PCK, NS2, uncompressed NSA, FJSYS, INT, ARCG, MGPK, ACTGS, ADS, and NOA archives, plus GAL, CRZ, RCT, and MCG image reading.
...
- PNG, JPEG, BMP, GAL, CRZ, encrypted RGB RCT, and encrypted v101 MCG regression coverage through the platform-neutral image layer.
