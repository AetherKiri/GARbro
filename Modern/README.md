...
- Avalonia desktop browser for folders, ZIP, XP3, TCD, and Morning PAK archives.
...
- CLI listing and safe extraction for ZIP, XP3, TCD, and Morning PAK archives.
