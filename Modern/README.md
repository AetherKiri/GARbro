...
- Avalonia desktop browser for folders, ZIP, XP3, TCD, Morning PAK, Moonhir FPK, CMP, PKG/2, CSAF, MBL, NPK, PCK, NS2, uncompressed NSA, FJSYS, INT, ARCG, ACTGS, ADS, and NOA archives, plus GAL and CRZ image reading.
...
- CLI listing and safe extraction for ZIP, XP3, TCD, Morning PAK, Moonhir FPK, CMP, PKG/2, CSAF, MBL, NPK, PCK, NS2, uncompressed NSA, FJSYS, INT, ARCG, ACTGS, ADS, and NOA archives.
- Standard unencrypted XP3 archives, plus explicitly selected migrated generic encryption schemes.
- PNG, JPEG, BMP, GAL, and CRZ regression coverage through the platform-neutral image layer.
