...
- Avalonia desktop browser for folders, ZIP, XP3, TCD, Morning PAK, and Moonhir FPK archives.
...
- CLI listing and safe extraction for ZIP, XP3, TCD, Morning PAK, and Moonhir FPK archives.
