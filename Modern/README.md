...
- Avalonia desktop browser for folders, ZIP, XP3, TCD, Morning PAK, Moonhir FPK, CMP, PKG/2, CSAF, MBL, NPK, PCK, NS2, uncompressed NSA, FJSYS, INT, ARCG, MGPK, ACTGS, ADS, and NOA archives, plus GAL, CRZ, RCT, MCG, and DAT/SPEED image reading.
