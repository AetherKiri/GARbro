...
- Avalonia desktop browser for folders, ZIP, XP3, TCD, Morning PAK, Moonhir FPK, CMP, PKG/2, CSAF, and MBL archives.
...
- CLI listing and safe extraction for ZIP, XP3, TCD, Morning PAK, Moonhir FPK, CMP, PKG/2, CSAF, and MBL archives.
