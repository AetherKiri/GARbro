...
- The legacy `Formats.dat` BinaryFormatter database is rejected by the modern runtime. XP3, ZIP, TCD, Morning PAK, Moonhir FPK, CMP, PKG/2, CSAF, MBL, NPK, PCK, NS2, NSA, FJSYS, INT, ARCG, MGPK, RCT, MCG, TINK, BIN/IDX, ARC/AZ, ARC/AZ/encrypted, PKZ, PBZ, KCAP, ARC/AI5WIN, NPA, PSB/EMOTE, AM/Leaf, LPK, GYU, YPF, ARC/Tactics/2, ARC/RPM, DATA/Csystem, AVC, DPK, PAK/AGSI, NOA, GAL, CRZ, ACTGS, ADS, and DAT/SPEED records currently use checksum-verified v2 data; remaining format-specific records still require explicit migration adapters.
