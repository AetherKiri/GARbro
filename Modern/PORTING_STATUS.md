...
- KiriKiri XP3 creation, listing, and extraction are available for standard unencrypted archives, including compressed index and content streams.
...
- Encrypted XP3 variants that depend on Hx, Senren, and other game-specific helpers remain on the legacy path until their option flow and helpers are migrated.
