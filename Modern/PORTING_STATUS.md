...
- The legacy `Formats.dat` BinaryFormatter database is rejected by the modern runtime. XP3, ZIP, TCD, Morning PAK, Moonhir FPK, CMP, PKG/2, CSAF, MBL, NPK, PCK, and NS2 records currently use checksum-verified v2 data; remaining format-specific records still require explicit migration adapters.
